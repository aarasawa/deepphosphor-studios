...
const services = [
  ...
  },
  {
    ...
    icon: Cpu,
    tags: ["Cloud", "Security", "Strategy", "Support"]
  },
  {
    title: "Photography",
    description: "Professional visual storytelling. From event coverage to architectural photography, capturing the essence of your brand.",
    icon: Camera,
    tags: ["Events", "Portraits", "Commercial", "Editing"]
  },
  {
    title: "Graphic Design",
    description: "Visual identity and brand systems. Partnering with expert designers to provide cohesive aesthetic solutions across all platforms.",
    icon: Palette,
    tags: ["Branding", "UI/UX", "Print", "Logos"]
  }
];
    ...
    <div className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <section className="mb-32">
        ...
        >
          ...
          <h1 className="text-7xl md:text-9xl font-bold mb-12 leading-none">
            <span className="text-amber-mid text-glow font-mono uppercase tracking-tighter drop-shadow-[0_0_30px_rgba(255,179,71,0.3)]">Craftsmanship.</span>
          </h1>
      ...
      <section id="services">
        <div className="flex items-center justify-between mb-12">
          ...
          <div className="hidden sm:block h-px flex-grow mx-8 bg-amber-mid/20"></div>
        </div>
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-wrap gap-2 mb-8">
                  {service.tags.map(tag => (
                    <span key={tag} className="text-[10px] uppercase tracking-widest font-sans px-2 py-1 bg-amber-mid/5 border border-amber-mid/10 rounded-sm">
                      {tag}
                    </span>
                  ))}
                </div>
                <button className="flex items-center space-x-2 text-amber-mid font-bold text-sm hover:translate-x-2 transition-transform">
