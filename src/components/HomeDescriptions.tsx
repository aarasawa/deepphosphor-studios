...
export const services: ServiceDetail[] = [
  {
    ...
    longDescription: "From a five-page Squarespace site to a fully custom React/Next.js application, we build for the full spectrum of what nonprofits and small businesses need. Every project starts with a scoping call to make sure the technology fits your needs.",
    icon: Code2,
    ...
    includes: [
      ...
      "Custom React / Next.js applications with headless CMS",
    ...
    goodFit: [
      "You're a nonprofit that needs an online presence with options for a donation system",
      "You have an existing site that's outdated or hard to maintain",
      "You need e-commerce website or business applications made custom to your workflow",
      "You want a technical partner, not just a vendor"
    ]
  },
  {
    title: "IT Consulting",
    ...
    longDescription: "Most small organizations are running on legacy systems and tools nobody fully understands. We audit what you have, identify risks, and help to build a system that works for you.",
    icon: Cpu,
    tags: ["Cloud", "Security", "SharePoint", "Microsoft 365", "Infrastructure", "Airtable", "Strategy", "Support"],
    includes: [
      ...
      "Power Apps and low-code internal tooling"
    ],
    goodFit: [
  ...
  },
  {
    ...
    longDescription: "Technology doesn't stop needing attention after launch. Plugins go out of date, integrations break, and staff changes occur. Our maintenance plans keep your systems running and give you a single point of contact when something goes wrong.",
    icon: Wrench,
  ...
  },
  {
    ...
    longDescription: "Migrations are high-stakes and easy to get wrong. We've moved nonprofits and small businesses from aging CMS platforms, deprecated tools, and tangled hosting setups onto clean, modern stacks. We handle the technical details so you can focus on your mission.",
    icon: ArrowRightLeft,
    ...
    goodFit: [
      ...
      "You want the migration done once, correctly, with no surprises"
    ]
  }
];